...
import imgui.api.fn.ImGuiInputTextCallback;
import imgui.api.fn.ImGuiItemsGetter;
import imgui.api.fn.ImGuiSizeCallback;

import static imgui.api.ImGuiMacros.FLT_MIN;
import static imgui.api.ImGuiMacros.IM_ASSERT;

// Note on ImVector -> List: Objects should be copied before insertion if mutable
...
public final class ImGui {
    ...
    public static int getKeyIndex(int key) {
        IM_ASSERT(key >= ImGuiKey.NamedKey_BEGIN && key < ImGuiKey.NamedKey_END);
        return key;
    }
