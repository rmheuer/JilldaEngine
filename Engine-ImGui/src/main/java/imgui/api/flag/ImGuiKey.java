...
public final class ImGuiKey {
    ...
    public static final int NamedKey_END = COUNT;
    public static final int NamedKey_COUNT = NamedKey_END - NamedKey_BEGIN;

    public static final int KeysData_SIZE = NamedKey_COUNT;
    public static final int KeysData_OFFSET = NamedKey_BEGIN;
